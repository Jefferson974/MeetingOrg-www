...
define("MESSAGE_EMAIL_NOT_BROOKES", "You have to use a brookes email");
define("MESSAGE_EMAIL_NO_IDSTART", "You email should be written with your ID : (p)123456@brookes.ac.uk");
